...
var DIFF_MODE_NORMAL = 0
var DIFF_MODE_INSERT = 1
var DIFF_MODE_DELETE = 2

// Space between list elements
var LI_MARGIN_BOTTOM = 8
...
replaceMalformedUmlauts = function (text) {
...
// var convertedHTML = convertHTML("<p>123</p><p><br></p><p><strong>Lorem Ipsum</strong>&nbspis simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen</p>")


// console.log('CONVERTED HTML', JSON.stringify(convertedHTML, null, 2))


exports.module = convertHTML